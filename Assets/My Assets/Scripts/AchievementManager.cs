...
public class AchievementManager : MonoBehaviour
{
    ...
    public void SetAchievementInfo(Transform parent, GameObject achievementPref, string title)
    {
        ...
        achievementPref.transform.GetChild(1).GetChild(1).GetComponent<TextMeshProUGUI>().text = achievements[title].title;
        achievementPref.transform.GetChild(1).GetChild(0).GetComponent<TextMeshProUGUI>().text = achievements[title].description;
        achievementPref.transform.GetChild(1).GetChild(2).GetChild(1).GetChild(0).GetComponent<Image>().sprite = achievements[title].icon;
        achievementPref.transform.GetChild(1).GetChild(3).GetChild(1).GetChild(0).GetComponent<TextMeshProUGUI>().text = achievements[title].points.ToString();
    }
    #endregion
